...
import com.finastra.apps.finhealth.domain.Employee;
import com.finastra.apps.finhealth.repository.EmployeeRepository;
...
/**
 * REST controller for managing {@link com.finastra.apps.finhealth.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class EmployeeResource {
    ...
    private static final String ENTITY_NAME = "finHealthEmployee";
