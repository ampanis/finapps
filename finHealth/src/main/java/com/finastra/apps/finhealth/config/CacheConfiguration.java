package com.finastra.apps.finhealth.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("finHealth");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("finHealth");
        ...
        config.getMapConfigs().put("com.finastra.apps.finhealth.domain.*", initializeDomainMapConfig(jHipsterProperties));
