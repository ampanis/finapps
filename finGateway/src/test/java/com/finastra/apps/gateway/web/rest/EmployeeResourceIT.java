...
import com.finastra.apps.gateway.domain.Employee;
import com.finastra.apps.gateway.repository.EmployeeRepository;
...
public class EmployeeResourceIT {
    ...
    public void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getWorkDayNo()).isEqualTo(DEFAULT_WORK_DAY_NO);
    ...
    public void updateEmployee() throws Exception {
        ...
        Employee testEmployee = employeeList.get(employeeList.size() - 1);
        assertThat(testEmployee.getWorkDayNo()).isEqualTo(UPDATED_WORK_DAY_NO);
